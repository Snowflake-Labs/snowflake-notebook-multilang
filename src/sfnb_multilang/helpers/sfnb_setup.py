...
CANONICAL SOURCE -- This is the single source of truth.
  Derived copies are distributed to per-package notebook directories:
    - snowflakeR/inst/notebooks/sfnb_setup.py
    - RSnowflake/inst/notebooks/sfnb_setup.py
    - snowflake-notebook-multilang/notebooks/sfnb_setup.py
  Edit HERE, then copy to the locations above.
